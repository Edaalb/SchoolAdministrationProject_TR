...
public class OgretmenMenu implements IIslemler {
    ...
    ============= İŞLEMLER =============
        ...
        SEÇİMİNİZ:
     */
//oluşturacağımız list Öğretmen tipinde veriler depolayacak
        static ArrayList<Ogretmen> ogretmenList = new ArrayList<>();
        Scanner scan = new Scanner(System.in);


        public void ogretmenMenu() {
            ...
            while (true) {
            //kullanıcı küçük q girerse de kabul etsin diye toUpperCase
        ...
        public void silme() {
            if (!ogretmenList.isEmpty()) {
                ...
                String tcNo = scan.next();
        //remove index istediği için for i kullandık
                for (int i = 0; i < ogretmenList.size(); i++) {
